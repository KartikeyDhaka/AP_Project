...
import sprites.Tank3re;

public class PlayState3 extends State{
    private Tank2 tank;
    private Tank3re tank2;
    ...
    public PlayState3(final GameStateManager gsm){
        super(gsm);
        ...
        tank = new Tank2(50, 100);
        tank2 = new Tank3re(50, 100);
...
//        sb.draw(health2, 1083, 600, 240, 30);
        ...
        sb.draw(tank2.getTexture(), 1143 - tank2.getPosition().x, tank2.getPosition().y, 50, 30);
