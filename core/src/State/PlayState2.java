...
import sprites.Tankre;

public class PlayState2 extends State{
    private Tank3 tank;
    private Tankre tank2;
    ...
    public PlayState2(final GameStateManager gsm){
        super(gsm);
        ...
        tank = new Tank3(50, 100);

        tank2 = new Tankre(50, 100);
