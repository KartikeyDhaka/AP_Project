...
public class Selecting3 extends State{
    private Tank2 tank;
    ...
    public Selecting3(final GameStateManager gsm){
        super(gsm);
        ...
        t1.setSize(300,100);
        t1.getStyle().imageUp = new TextureRegionDrawable(new TextureRegion(new Texture(Gdx.files.internal("Tank2.png"))));
        t1.getStyle().imageDown = new TextureRegionDrawable(new TextureRegion(new Texture(Gdx.files.internal("Tank2.png"))));
        stage.addActor(t1);
