...
public class Over2 extends State{
    ...
    public Over2(final GameStateManager gsm){
        super(gsm);
        ...
        resume = new TextButton("Restart",mySkin,"default");
        ...
        setting = new TextButton("Tank 1 wins",mySkin,"default");
